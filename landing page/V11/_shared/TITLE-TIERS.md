...
**본문 안의 굵은 리드인은 예외가 아니다** — SD 리서치 목록, Managed 거절 목록의 굵은 첫 마디는 17 항목 제목이라 500 이다. manifesto 목록 항목이 500 인 것도 같은 이유.
...
값을 바꿀 때는 `_shared/v11.css` 를 고치고 `python _shared/check-v11.py` 로 확인할 것.
