...
function AppScreenGrid() {
  ...
  const panel = (src: string, delay: number) => (
    <div
      ...
      onMouseEnter={e => {
        ...
        ;(e.currentTarget as HTMLDivElement).style.transition = 'transform 0.45s cubic-bezier(0.16,1,0.3,1)'
      }}
      onMouseLeave={e => {
        (e.currentTarget as HTMLDivElement).style.transform = 'scale(1)'
        ;(e.currentTarget as HTMLDivElement).style.transition = 'transform 0.7s cubic-bezier(0.16,1,0.3,1)'
      }}
    >
  ...
  return (
    <div ref={ref} className="screen-grid" style={{ display: 'flex', gap: 50, alignSelf: 'flex-end' }}>
...
function Section({ number, title, body, indent }: {
  ...
  return (
    <Reveal>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 28, maxWidth: 650, paddingLeft: 0 }}>
        ...
        <Reveal>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 30, maxWidth: 650, paddingLeft: 127 }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 15 }}>
              ...
              <span className="landing-title-text" style={{ fontFamily: "'Inter', sans-serif", fontSize: 21, color: '#c7c7c7', letterSpacing: '0px', lineHeight: 1.4 }}>
                A calm environment for deliberate capital allocation.
              </span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 13 }}>
              <p className="landing-body-text" style={{ fontFamily: "'Inter', sans-serif", fontSize: 21, color: '#929292', margin: 0, letterSpacing: '0px', lineHeight: 1.55, opacity: 0.9 }}>No noise. No urgency. No distraction.</p>
              <p className="landing-body-text" style={{ fontFamily: "'Inter', sans-serif", fontSize: 21, color: '#929292', margin: 0, letterSpacing: '0px', lineHeight: 1.55, opacity: 0.9 }}>This is where decisions are made,<br />not reactions.</p>
            </div>
          </div>
        </Reveal>
